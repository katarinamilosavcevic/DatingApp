...
namespace DatingApp.Data.Migrations
{
    ...
    [Migration("20260407131034_BlockingAndReporting")]
    partial class BlockingAndReporting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingApp.Entities.BlockedUser", b =>
                {
            ...
            modelBuilder.Entity("DatingApp.Entities.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "member-id",
                            ConcurrencyStamp = "b60105f1-3c69-4c87-bae8-0ef941c42feb",
                            Name = "Member",
                        ...
                        {
                            Id = "moderator-id",
                            ConcurrencyStamp = "c66dd368-8b6c-491f-9418-fbeb2d35e74c",
                            Name = "Moderator",
                        ...
                        {
                            Id = "admin-id",
                            ConcurrencyStamp = "add4463e-9a39-4e3e-b287-178a4276c91d",
                            Name = "Admin",
            ...
            modelBuilder.Entity("DatingApp.Entities.Report", b =>
                {
                    b.HasOne("DatingApp.Entities.Member", "ReportedUser")
                        .WithMany()
                        .HasForeignKey("ReportedUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DatingApp.Entities.Member", "Reporter")
                        .WithMany()
